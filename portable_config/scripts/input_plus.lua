...
local function edit_file(path)
	...
	local full_path = mp.command_native({"expand-path", path})
	mp.command('no-osd run cmd /c start notepad "' .. full_path .. '"')
end
...
mp.register_script_message("edit", function(path) edit_file(path) end)
